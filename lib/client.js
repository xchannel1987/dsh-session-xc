  ...
  factory: (require) => {
    ...
    function apply(ctx) {
      ...
      if (typeof document !== "undefined" && typeof window !== "undefined") {
        visibilityHandler = function () { if (!document.hidden) { try { var wsSnapshot = workspacesList.getSnapshot(); if (wsSnapshot && wsSnapshot.phase === "ready") { var sessionsSnapshot = workspacesService && workspacesService.sessions && workspacesService.sessions.list ? workspacesService.sessions.list.getSnapshot() : null; computeArchiveData(wsSnapshot, sessionsSnapshot); } } catch (e) { /* ignore */ } } };
