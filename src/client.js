    ...
    function apply(ctx) {
      ...
      function refreshFromStores() {
        try {
          ...
          var sessionsList = workspacesService && sessionsService && sessionsService.list;
      ...
      var sessionsListForSubscription = workspacesService && sessionsService && sessionsService.list;
